...
const AlertDashboard = ({ isLoading, products }) => {
                                                    ...
                                                    <Table aria-label="simple table" sx={{ width: '413px' }}>
                                                        <TableHead >
                                                            <TableRow>
                                                                ...
                                                                <TableCell sx={{ color: '#fff!important' }} align="left">Remain</TableCell>
                                                                <TableCell sx={{ color: '#fff!important' }} align="left">Status</TableCell>
                                                            </TableRow>
                                                        </TableHead>
                                                        <TableBody>
                                                            {products.map((row) => {
                                                                const alertQuantity = row.alert_quantity ? parseInt(row.alert_quantity) : 0;
                                                                const stock = parseInt(row.stock_in) - parseInt(row.stock_out);
                                                                // console.log('first', stock, alertQuantity)
                                                                if (alertQuantity >= stock) {
                                                                    return (
                                                                        <TableRow
                                                                            key={row.name}
                                                                            sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                                                                        >
                                                                            <TableCell component="th" scope="row" sx={{ color: '#fff!important' }}>
                                                                                {row.product_name}
                                                                            </TableCell>
                                                                            <TableCell sx={{ color: '#fff!important' }} align="left">{stock}</TableCell>
                                                                            <TableCell sx={{ color: '#fff!important' }} align="left">Soon Stock Out</TableCell>
                                                                        </TableRow>
                                                                    )
                                                                }
                                                            })}
