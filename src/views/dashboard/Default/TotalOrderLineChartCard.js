...
const TotalOrderLineChartCard = ({ isLoading, totalOrder, handleOrder }) => {
                            ...
                            <Grid item>
                                <Grid container justifyContent="space-between">
                                    ...
                                    <Grid item>
                                        ...
                                        <Button
                                            disableElevation
                                            variant={timeValue === 'yesterday' ? 'contained' : 'text'}
                                            size="small"
                                            sx={{ color: 'inherit' }}
                                            onClick={(e) => handleChangeTime(e, 'yesterday')}
                                        >
                                            Yesterday
                                        </Button>
                                        <Button
                                            ...
                                            size="small"
                                            sx={{ color: 'inherit' }}
                                            onClick={(e) => handleChangeTime(e, 'weekly')}
                                        >
                                            weekly
                                        </Button>
                                        <Button
