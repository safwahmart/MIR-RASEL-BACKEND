...
const CategoriesTypeList = () => {
    ...
    const handleConfirmationDialog = useConfirmationDialog(
        language === 'en-US' ? "Delete WareHouse?" : "অ্যাট্রিবিউট মুছবেন?",
    ...
    const deleteWareHouses = async (id) => {
        try {
            ...
            if (confirmed) {
                ...
                const result = await axios.delete(`${baseUrl}/wareHouses/${id}`, {
                    headers: headers,
                });
    ...
    const handleStatusUpdate = (row) => {
        ...
        axios
            .post(
                `${baseUrl}/wareHouses/` + row.id, formData,
            ...
            .then(function (response) {
                showToast(
                    response.data.data.status == 1 ? "WareHouses  enable" : "WareHouses Disable ",
                    "success"
                );
    ...
    return (
        <MainCard title={t("WareHouses List")} content={false}>
            <CardContent>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? toBengaliNumber(row.contact_no) : row.contact_no}{' '}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            component="th"
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? toBengaliNumber(row.bin_no) : row.bin_no}{' '}
                                            </Typography>
                                        </TableCell>
