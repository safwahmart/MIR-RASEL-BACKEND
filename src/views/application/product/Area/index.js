...
const CategoriesTypeList = () => {
    ...
    const handleConfirmationDialog = useConfirmationDialog(
        language === 'en-US' ? "Delete Area?" : "অ্যাট্রিবিউট মুছবেন?",
    ...
    const handleStatusUpdate = (row) => {
        ...
        axios
            ...
            .then(function (response) {
                showToast(
                    response.data.data.status == 1 ? "Areas  enable" : "Areas Disable ",
                    "success"
                );
                handelFatchAreas()
            })
    ...
    return (
        <MainCard title={t("Areas List")} content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        ...
                        <AreaAdd handelFatchAreas={handelFatchAreas} open={open} handleCloseDialog={handleCloseDialog} selectedData={selectedData} />
                    </Grid>
                </Grid>
            </CardContent>
