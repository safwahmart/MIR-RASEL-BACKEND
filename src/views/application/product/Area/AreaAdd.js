...
const validationSchema = Yup.object().shape({
    ...
    name_bn: Yup.string().required('Area bn name is required'),
        ...
        try {
            ...
            const response =
                Object.keys(selectedData).length > 0
                    ? await axios.post(`${baseUrl}/areas/${selectedData.id}`, formData, {
                        headers: headers
                    })
                                        ...
                                        <Field name="district_id">
                                            {({ field }) => (
                                                <Select
                                                    ...
                                                    fullWidth
                                                    label="District"
                                                    error={errors.district_id && touched.district_id}
                                                >
                                                    <MenuItem value="">
                                                        <em>None</em>
                                                    </MenuItem>
