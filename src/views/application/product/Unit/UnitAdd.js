...
const HighlightTypeAdd = ({ open, handleCloseDialog, handelFatchUnits, selectedData }) => {
    ...
    const onSubmit = async (values) => {
        try {
            ...
            const response = Object.keys(selectedData).length > 0 ? await axios.post(`${baseUrl}/units/${selectedData.id}`, formData, {
                headers: headers
            }) : await axios.post(`${baseUrl}/units`, formData, {
                headers: headers
            });
        ...
        >
            {open && (
                ...
                >
                    {({ errors, touched }) => (
                        <Form>
                            <DialogTitle>{Object.keys(selectedData).length > 0 ? t('Edit') : t('Add')} {t('Your Unit')}</DialogTitle>
                            <DialogContent>
