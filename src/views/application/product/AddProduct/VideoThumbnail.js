...
const VideoThumbnail = ({ setFieldValue }) => {
    const theme = useTheme();
    const [selectedImage, setSelectedVideoImage] = useState(null);
    ...
    const handleImageUpload = (event) => {
        ...
        setFieldValue("video_thumbnail", file)
        if (file) {
            ...
            reader.onload = () => {
                ...
                setTimeout(() => {
                    setSelectedVideoImage(reader.result);
    ...
    const handleDeleteImage = () => {
        setFieldValue("video_thumbnail", null)
    ...
    return (
        <>
            ...
            <Grid item xs={12}>
                <div>
                    <TextField type="file" id="file-upload-video" fullWidth label="Enter SKU" onChange={handleImageUpload} sx={{ display: 'none' }} />
                    <InputLabel
