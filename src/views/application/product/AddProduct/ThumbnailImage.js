...
const ThumbnailImage = ({ setFieldValue }) => {
    ...
    const handleImageUpload = (event) => {
        ...
        setFieldValue("product_thumbnail", file)
        if (file) {
    ...
    const handleDeleteImage = () => {
        setFieldValue("product_thumbnail", null)
    ...
    return (
        <>
            ...
            <Grid item xs={12}>
                <div>
                    <TextField type="file" id="file-upload-thumbnail" fullWidth label="Enter SKU" onChange={handleImageUpload} sx={{ display: 'none' }} />
                    <InputLabel
