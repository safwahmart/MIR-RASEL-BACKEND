...
const VariationFile = ({ setFieldValue }) => {
    ...
    const handleImageUpload = (event) => {
        ...
        setFieldValue("variation_upload_file", file)
        if (file) {
    ...
    const handleDeleteImage = () => {
        setFieldValue("variation_upload_file", null)
    ...
    return (
        <>
            ...
            <Grid item xs={12}>
                <div>
                    <TextField type="file" accept={".csv"} id="file-upload-thumbnail" fullWidth label="Enter SKU" onChange={handleImageUpload} sx={{ display: 'none' }} />
                    <InputLabel
