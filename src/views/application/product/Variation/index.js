...
const CategoriesTypeList = () => {
  ...
  const handleFetchCategoriesType = React.useCallback(
    async () => {
      try {
        const data = await axios.get(`${baseUrl}/variations`, {
          headers: headers
        });
  ...
  const deleteCategory = async (id) => {
    try {
      ...
      if (confirmed) {
        ...
        const result = await axios.delete(`${baseUrl}/variations/${id}`, {
          headers: headers,
        });
  ...
  const handelFatchVariationUpload = () => {
    setFetch(true);
  }

  const redirectToNewRoute = (id) => {
    console.log('Redirecting to', id);
    navigate(`/variations/edit?id=${id}`);
  }
  ...
  return (
    <MainCard title={t("Variation List")} content={false}>
      <CardContent>
        <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
          ...
          <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
            ...
            <VariationAdd handelFatchVariationUpload={handelFatchVariationUpload} open={open} handleCloseDialog={handleCloseDialog} selectedData={selectedData} />
          </Grid>
        </Grid>
      </CardContent>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {' '}
                        {language === 'bn' ? row.sale_price : row.sale_price}{' '}
                      </Typography>
                    </TableCell>
                    <TableCell
                      component="th"
                    ...
                    >
                      ...
                      >
                        {' '}
                        {language === 'bn' ? row.opening_quantity : row.opening_quantity}{' '}
                      </Typography>
                    </TableCell>
                  </TableRow>
                );
