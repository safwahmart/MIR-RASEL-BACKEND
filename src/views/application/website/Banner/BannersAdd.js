...
const BannerAdd = ({ open, handleCloseDialog, handelFatchBanners, selectedData }) => {
    ...
    const onSubmit = async (values) => {
        try {
            ...
            formData.append('banner_name', values.name);
            formData.append('banner_name_bn', values.name_bn);
            ...
            const response = Object.keys(selectedData).length > 0 ? await axios.post(`${baseUrl}/banners/${selectedData.id}`, formData, {
                headers: headers
            ...
            {open && (
                ...
                >
                    {({ errors, touched, values, setFieldValue }) => (
                        <Form>
                            <DialogTitle>{Object.keys(selectedData).length > 0 ? t('Edit') : t('Add')} {t("Your Banners")}</DialogTitle>
                            <DialogContent>
                                        ...
                                        <Field name="banner_url">
                                            {({ field }) => (
                                                <TextField
                                                    ...
                                                    fullWidth
                                                    label={t("Banner URL") + '*'}
                                                    error={errors.banner_url && touched.banner_url}
                                                    helperText={
