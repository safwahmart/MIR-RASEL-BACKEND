...
import BrandsAdd from './BannersAdd';
...
const CategoriesTypeList = () => {
    ...
    const handleConfirmationDialog = useConfirmationDialog(
        language === 'en-US' ? 'Delete Banners?' : 'ব্র্যান্ড মুছবেন?',
    ...
    const deleteBanners = async (id) => {
        try {
            ...
            if (confirmed) {
                ...
                const result = await axios.delete(`${baseUrl}/banners/${id}`, {
                    headers: headers
                });
    ...
    return (
        <MainCard title={t('Banners List')} content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    <Grid item xs={12} sm={6}></Grid>
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        {/* product add & dialog */}
                        <Tooltip title={t('Add Banners')}>
                            <Fab
                                color="primary"
                                size="small"
                        ...
                        <BrandsAdd
                            handelFatchBanners={handelFatchBanners}
                            open={open}
                                ...
                                return (
                                    <TableRow key={row.id}>
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? row.banner_name_bn : row.banner_name}{' '}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            component="th"
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? row.banner_url : row.banner_url}{' '}
                                            </Typography>
                                        </TableCell>
