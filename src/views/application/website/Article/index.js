...
const ArticleList = () => {
    ...
    const handleConfirmationDialog = useConfirmationDialog(
        language === 'en-US' ? 'Delete Article?' : 'আর্টিকেল মুছবেন?',
    ...
    const deleteBanners = async (id) => {
        try {
            ...
            if (confirmed) {
                ...
                const result = await axios.delete(`${baseUrl}/articles/${id}`, {
                    headers: headers
                });
    ...
    const handleStatusUpdate = (row) => {
        ...
        axios
            ...
            .then(function (response) {
                showToast(response.data.data.status == 1 ? 'Article enable' : 'Article Disable ', 'success');
                handelFatchBanners();
            })
