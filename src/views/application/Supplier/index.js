...
const CategoriesTypeList = () => {
    ...
    const handleConfirmationDialog = useConfirmationDialog(
        language === 'en-US' ? "Delete Attribute Supplier?" : "ট্যাগ মুছবেন?",
    ...
    const handleStatusUpdate = (row) => {
        ...
        formData.append('supplier_name', row.supplier_name);
        formData.append('status', row.status === 0 ? 1 : 0);
        formData.append('_method', 'PUT');
        axios
            .post(
                `${baseUrl}/suppliers/` + row.id, formData,
            ...
            .then(function (response) {
                showToast(
                    response.data.data.status == 1 ? "Supplier  enable" : "Supplier Disable ",
                    "success"
                );
                handelFatchSupplier()
            })
    ...
    return (
        <MainCard title={t("Supplier List")} content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        ...
                        <SupplierAdd handelFatchSupplier={handelFatchSupplier} open={open} handleCloseDialog={handleCloseDialog} selectedData={selectedData} />
                    </Grid>
                </Grid>
            </CardContent>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? toBengaliNumber(row.address) : row.address}{' '}
                                            </Typography>
                                        </TableCell>
