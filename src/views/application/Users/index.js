...
const CategoriesTypeList = () => {
    ...
    const handleConfirmationDialog = useConfirmationDialog(
        language === 'en-US' ? 'Delete Attribute User?' : 'ট্যাগ মুছবেন?',
    ...
    const deleteUser = async (id) => {
        try {
            ...
            if (confirmed) {
                ...
                const result = await axios.delete(`${baseUrl}/users/${id}`, {
                    headers: headers
                });
    ...
    const handleStatusUpdate = (row) => {
        ...
        axios
            ...
            .then(function (response) {
                showToast(response.data.data.status == 1 ? 'User  enable' : 'User Disable ', 'success');
                handelFatchUser();
            })
    ...
    return (
        <MainCard title={t('User List')} content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        ...
                        <UserAdd
                            handelFatchUser={handelFatchUser}
                            open={open}
                                ...
                                return (
                                    <TableRow key={row.id}>
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? row.email : row.email}{' '}
                                            </Typography>
                                        </TableCell>
                                        ...
                                        <TableCell align="center" sx={{ pr: 3 }}>
                                            ...
                                            <IconButton
                                                onClick={() => navigate(`/permission-access/${row.id}`)}
                                                color="secondary"
                                                size="large"
                                                aria-label="edit"
                                            >
                                        ...
                                        <TableCell align="center" sx={{ pr: 3 }}>
                                            ...
                                            <IconButton onClick={() => deleteUser(row?.id)} color="primary" size="large" aria-label="delet">
