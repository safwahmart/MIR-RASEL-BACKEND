...
const CategoriesTypeList = () => {
    ...
    const printOrder = (data) => {
        ...
        window.open(`/inventory/sale/${data.id}`, "_blank")
    }
    ...
    const deletePurchase = async (id) => {
        try {
            ...
            if (confirmed) {
                ...
                const result = await axios.delete(`${baseUrl}/sales/${id}`, {
                    headers: headers,
                });
    ...
    return (
        <MainCard title={t("Sale List")} content={false}>
            <CardContent>
                    ...
                    <TableBody>
                        {stableSort(rows, getComparator(order, orderBy))
                            ...
                            .map((row, index) => {
                                ...
                                console.log('Row Data Sale List:', row);
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? toBengaliNumber(row.sale_date) : row.sale_date}{' '}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            component="th"
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? toBengaliNumber(row.paid_amount) : row.paid_amount}{' '}
                                            </Typography>
                                        </TableCell>
                                        ...
                                        <TableCell
                                            ...
                                            sx={{ cursor: 'pointer' }}
                                        >
                                            akhne ki dhoroner payment seta bole dite hobe
                                        </TableCell>
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? toBengaliNumber(row.due) : row.due}{' '}
                                            </Typography>
                                        </TableCell>
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? toBengaliNumber(row.change) : row.change}{' '}
                                            </Typography>
                                        </TableCell>
