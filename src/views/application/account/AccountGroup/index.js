...
const CategoriesTypeList = () => {
    ...
    const handleConfirmationDialog = useConfirmationDialog(
        language === 'en-US' ? "Delete AccountGroup?" : "অ্যাট্রিবিউট মুছবেন?",
    ...
    const handleFetchCategoriesType = React.useCallback(
        async () => {
            try {
                const data = await axios.get(`${baseUrl}/accountGroups`, {
                    headers: headers
                });
    ...
    const deleteAccountGroups = async (id) => {
        try {
    ...
    const handleStatusUpdate = (row) => {
        ...
        axios
            ...
            .then(function (response) {
                showToast(
                    response.data.data.status == 1 ? "AccountGroups  enable" : "AccountGroups Disable ",
                    "success"
                );
                handelFatchAccountGroups()
            })
    ...
    const handelFatchAccountGroups = () => {
        setFetch(true);
    }
    ...
    return (
        <MainCard title={t("Account Groups List")} content={false}>
            <CardContent>
                <Grid container justifyContent="space-between" alignItems="center" spacing={2}>
                    ...
                    <Grid item xs={12} sm={6} sx={{ textAlign: 'right' }}>
                        ...
                        <AccountGroupAdd handelFatchAccountGroups={handelFatchAccountGroups} open={open} handleCloseDialog={handleCloseDialog} selectedData={selectedData} />
                    </Grid>
                </Grid>
            </CardContent>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                {' '}
                                                {language === 'bn' ? row.balance_type_bn : row.balance_type}{' '}
                                            </Typography>
                                        </TableCell>
