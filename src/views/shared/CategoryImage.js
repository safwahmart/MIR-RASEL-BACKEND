...
const CategoryImage = ({ setFieldValue }) => {
    ...
    const handleDeleteImage = () => {
        setFieldValue("category_image", null)
    ...
    return (
        <>
            ...
            <Grid item xs={12}>
                <div>
                    <TextField type="file" id="file-upload-image" fullWidth label="Enter SKU" onChange={handleImageUpload} sx={{ display: 'none' }} />
                    <InputLabel
